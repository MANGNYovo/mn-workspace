...
import type { FloatingPlayerMode, FloatingPlayerPosition, PlaylistTrack } from '../types'
      ...
      {mode === 'expanded' ? (
        <>
          ...
          <div className="floating-player-bottom">
            ...
            <button
              type="button"
              className={`floating-player-like-button ${isLiked ? 'active' : ''}`}
        ...
        <>
          ...
          <button
            type="button"
            className={`floating-player-like-button floating-player-mini-like-button ${isLiked ? 'active' : ''}`}
            onClick={onToggleLike}
            title={isLiked ? 'Unlike' : 'Like'}
            aria-label={isLiked ? 'Unlike current track' : 'Like current track'}
            data-no-drag="true"
