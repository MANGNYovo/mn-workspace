...
function App() {
  ...
  const activeTheme: ResolvedTheme = settings.theme === 'System'
    ? systemTheme
  ...
  // ─── Render ───────────────────────────────────────────────────────────────
  return (
    <div className="app" data-theme={activeTheme} data-accent={settings.accentColor} style={appStyle}>
      {/* 타이틀바 */}
