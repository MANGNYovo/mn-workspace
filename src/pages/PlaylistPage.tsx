    ...
    <section className="playlist-page">
      <div className="playlist-main">
        ...
        <div className="playlist-toolbar">
          ...
          >
            <img
              src={iconMap.check[isRefreshButtonHovered && isYtAuthenticated && !isPlaylistRefreshing ? accentColor : 'gray']}
              alt=""
              className="playlist-refresh-icon"
            />
          </button>
        ...
        <div className="playlist-detail-card">
          ...
          >
            {playingPlaylistId === selectedHomeMusicPlaylistId && isHomeMusicPlaying ? (
              <><img src={playbackIconMap.pause.white} alt="" className="playlist-play-button-icon" />Pause</>
            ) : (
              <><img src={playbackIconMap.start.white} alt="" className="playlist-play-button-icon" />Play Playlist</>
            )}
          </button>
